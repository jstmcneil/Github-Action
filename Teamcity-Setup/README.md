...
## Import Project
For direct usage within TeamCity, either clone this repo or download the [Project Import Zip](/TeamCity-PaC-Dockerized.zip). Then, as an** TeamCity adminstrator/super-user**, do the following:
